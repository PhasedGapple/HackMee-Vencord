# MeeCord
#### Warning if you have this error, ![image](https://github.com/user-attachments/assets/735996bd-696b-47ad-ba57-76d624d63eef) try temporarely deleting HackMee-Vencord by using the repair button in the Vencord installer. This is usually caused by a faulty plugin activated by the user. If you wanna check if a plugin might be faulty, check the newest [Github Actions Build](https://github.com/PhasedGapple/HackMee-Vencord/actions) for errors in a plugin
...
NOT the cutest Discord client mod, though still a Vencord fork.
